...
namespace PrjLoja
{
    public partial class frmConsultaFunc : Form
    {
        ...
        {
            string strSQL = "select * from tblFuncionario";
        ...
        {
            string strSQL = "select * from tblFuncionario order by '" + cbOrder.Text + "'";
            ...
            {
                Command = new SqlCommand("select * from tblFuncionario", Connect);
                SqlDataAdapter objAdp = new SqlDataAdapter(Command);
                DataTable dtLista = new DataTable();
                objAdp.Fill(dtLista);
        ...
        {
            string strSQL = "select * from tblFuncionario where " + cbFiltro.Text + " = '" + txtFiltro.Text + "' ";
            Connect = new SqlConnection(strConexao);
            Command = new SqlCommand(strSQL, Connect);
